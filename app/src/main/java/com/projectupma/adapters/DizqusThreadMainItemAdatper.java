...
import com.projectupma.activities.DizqusCommentActivity;
...
public class DizqusThreadMainItemAdatper extends RecyclerView.Adapter<DizqusThreadMainItemAdatper.ViewHolder> {
    List<DizqusThreadModel> dizqusThreadModels;
    Context context;
    HashMap<String, Integer> userIndex;
    List<String> threadIds;
    UserModel userModel = new UserModel();

    public DizqusThreadMainItemAdatper(List<DizqusThreadModel> dizqusThreadModels, Context context, List<String> threadIds) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void methods(DizqusThreadModel dizqusThreadModel, String threadID, int position) {
        ...
        private void openMoreDialog(DizqusThreadModel dizqusThreadModel, String threadID, int position) {
        ...
        private void openPost(DizqusThreadModel dizqusThreadModel, String threadId) {
        ...
        private void setData(DizqusThreadModel dizqusThreadModel) {
...
//            UserModel userModel = userModels.get(position);
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if (task.isSuccessful()) {
                        for (QueryDocumentSnapshot document1 : task.getResult()) {
                            ...
                            txtBranchDisquzThreadItem.setText(userModel.getBranch());
            ...
            no_likes_dizqus_main.setText(dizqusThreadModel.getLikes().size() + " Likes");
            {
                ...
                Point x = new Point();
                ((DizqusThreadActivity) context).getWindowManager().getDefaultDisplay().getSize(x);
