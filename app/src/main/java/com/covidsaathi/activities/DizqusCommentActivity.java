...
import com.covidsaathi.adapters.DizqusCommentItemAdapter;
import com.covidsaathi.models.CommentModel;
...
public class DizqusCommentActivity extends AppCompatActivity {
    ...
    private void getActivityData() {
        ...
        Log.d(TAG, "getActivityData: "+thread_id);
    }
    ...
    private void getAllComments(UserModel userModel) {
        ...
        Db.db.collection(Db.COMMENTS_COL).whereEqualTo("thread_id", thread_id).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
