...
import com.covidsaathi.adapters.DizqusThreadTileAdapter;
import com.covidsaathi.adapters.HomePageImageSliderAdapter;
...
public class DashboardFragment extends Fragment {
    ...
    private void loadSocietiesFragment() {
        AppHelper.replaceFragments(SocietiesFragment.class,getActivity(), null);
    ...
    private void loadDizqusActivity() {
        ...
        i.putExtra("ActivityType","DizqusThread");
        startActivity(i);
    }
